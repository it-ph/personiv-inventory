...
class KeyboardController extends Controller
{
    ...
    */
    ...
    {
        return DB::table('keyboards')->select('*')->where('brand', '=', $request->brand)->get();
    }
    ...
    */
    ...
    {
        return DB::table('keyboards')->select('*', DB::raw('LEFT(brand, 1) as first_letter'), DB::raw('DATE_FORMAT(created_at, "%h:%i %p, %b. %d, %Y") as created_at'))->whereNull('deleted_at')->orderBy('updated_at', 'desc')->paginate(25);
    }
    ...
    {
        return Keyboard::where('id', $id)->first();
    }
