...
class NetworkSwitchController extends Controller
{
    ...
    {
        return DB::table('network_switches')->select('*', DB::raw('LEFT(brand, 1) as first_letter'))->whereNotIn('id', [$id])->get();
    }
    /**
    ...
    */
    ...
    {
        return DB::table('network_switches')->select('*')->where('brand', '=', $request->brand)->get();
    }
    ...
    */
    ...
    {
        return DB::table('network_switches')
    ...
    */
    ...
    {
        return DB::table('network_switches')->select('*', DB::raw('LEFT(model, 1) as first_letter'), DB::raw('DATE_FORMAT(created_at, "%h:%i %p, %b. %d, %Y") as created_at'))->whereNull('deleted_at')->orderBy('updated_at', 'desc')->paginate(25);
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        $log->activity_id = $network_switch->id;
        $log->activity = 'added a new Network Switch.';
