...
class HardDiskController extends Controller
{
    ...
    {
        return DB::table('hard_disks')->select('*', DB::raw('LEFT(brand, 1) as first_letter'))->whereNotIn('id', [$id])->get();
    }
    /**
    ...
    */
    ...
    public function store(Request $request)
    {
        ...
        $log->activity_id = $hardDisk->id;
        $log->activity = 'added a new Hard Disk.';
