...
class TelephoneController extends Controller
{
    ...
    {
        return DB::table('telephones')->select('*', DB::raw('LEFT(brand, 1) as first_letter'))->whereNotIn('id', [$id])->get();
    }
    /**
    ...
    */
    ...
    {
        return DB::table('telephones')->select('*')->where('brand', '=', $request->brand)->get();
    }
    ...
    */
    ...
    public function store(Request $request)
    {
        ...
        $telephone->brand = $request->brand;
        $telephone->model = $request->model;
        ...
        $log->activity_id = $telephone->id;
        $log->activity = 'added a new Telephone.';
    ...
    {
        return Telephone::where('id', $id)->first();
    }
