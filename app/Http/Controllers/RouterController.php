...
class RouterController extends Controller
{
    ...
    {
        return DB::table('routers')->select('*', DB::raw('LEFT(brand, 1) as first_letter'))->whereNotIn('id', [$id])->get();
    }
    /**
    ...
    */
    ...
    {
        return DB::table('routers')->select('*')->where('brand', '=', $request->brand)->get();
    }
    ...
    */
    ...
    {
        return DB::table('routers')->select('*', DB::raw('LEFT(brand, 1) as first_letter'), DB::raw('DATE_FORMAT(created_at, "%h:%i %p, %b. %d, %Y") as created_at'))->whereNull('deleted_at')->orderBy('updated_at', 'desc')->paginate(25);
    }
    /**
